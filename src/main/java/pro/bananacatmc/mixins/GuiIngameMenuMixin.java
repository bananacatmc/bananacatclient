...
public abstract class GuiIngameMenuMixin extends GuiScreen {
    ...
    /**
     * @author duplicat
     * @reason add BananaCat Button to Game menu
     */
    @Overwrite
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(31, this.width / 2 + 2, this.height / 4 + 96 + i, 98, 20, "BananaCat Client"));
    ...
    /**
     * @author duplicat
     * @reason make BananaCat button load menu
     */
    @Overwrite
    protected void actionPerformed(GuiButton button) {
        switch (button.id) {
            ...
            case 30:
                ...
                break;
            case 31:
                this.mc.displayGuiScreen(BananaCat.INSTANCE.hudEditor);
                break;
        }
    }
}
