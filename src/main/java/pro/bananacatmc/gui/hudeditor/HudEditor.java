...
package pro.bananacatmc.gui.hudeditor;

import pro.bananacatmc.BananaCat;
import pro.bananacatmc.gui.Style;
import pro.bananacatmc.gui.hudeditor.impl.HudMod;
import pro.bananacatmc.gui.hudeditor.impl.impl.*;
import pro.bananacatmc.gui.hudeditor.impl.impl.keystrokes.KeystrokesHud;
import pro.bananacatmc.gui.modmenu.ModMenu;
...
public class HudEditor extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        BananaCat.INSTANCE.fontHelper.size40.drawString(
                BananaCat.modName,
                width / 2f - BananaCat.INSTANCE.fontHelper.size40.getStringWidth(BananaCat.modName) / 2f,
        ...
        Helper2D.drawPicture(
                ...
                50, 50, Style.getColor(70).getRGB(), "BananaCatlogo.png"
        );
        GLHelper.endScissor();
        ...
        BananaCat.INSTANCE.fontHelper.size20.drawString(
                "Open Mods",
                width / 2f - BananaCat.INSTANCE.fontHelper.size20.getStringWidth("Open Mods") / 2f,
                height / 2f,
                color
        );
        ...
        for (HudMod hudMod : hudModList) {
            ...
            for (HudMod sHudMod : hudModList) {
                if (
                        BananaCat.INSTANCE.modManager.getMod(sHudMod.getName()).isToggled() &&
                                hudMod.isDragging() &&
    ...
    public void onKey(InputEvent.KeyInputEvent e) {
        if (Keyboard.isKeyDown(BananaCat.INSTANCE.optionManager.getOptionByName("ModMenu Keybinding").getKey())) {
