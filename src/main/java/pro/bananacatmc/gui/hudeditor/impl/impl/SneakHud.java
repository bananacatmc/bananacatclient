...
import pro.bananacatmc.feature.mod.impl.ToggleSneakMod;
        ...
        if (BananaCat.INSTANCE.modManager.getMod(getName()).isToggled()) {
            if (isModern()) {
                ...
                BananaCat.INSTANCE.fontHelper.size20.drawString(
                        ...
                        getX() + getW() / 2f - BananaCat.INSTANCE.fontHelper.size20.getStringWidth("Sneak: " + (isSneaking() ? "Toggled" : "Vanilla")) / 2f,
                        getY() + 6,
                        getColor()
                );
            } else {
                ...
                BananaCat.INSTANCE.mc.fontRendererObj.drawString(
                        "Sneak: " + (isSneaking() ? "Toggled" : "Vanilla"),
                        getX() + getW() / 2 - BananaCat.INSTANCE.mc.fontRendererObj.getStringWidth("Sneak: " + (isSneaking() ? "Toggled" : "Vanilla")) / 2,
                        getY() + 6,
                        getColor()
                );
            }
