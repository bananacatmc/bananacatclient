        ...
        if (BananaCat.INSTANCE.modManager.getMod(getName()).isToggled()) {
            if (isModern()) {
                ...
                BananaCat.INSTANCE.fontHelper.size20.drawString(
                        ...
                        getX() + getW() / 2f - (BananaCat.INSTANCE.fontHelper.size20.getStringWidth(TimeHelper.getFormattedTimeSecond())) / 2f,
                        getY() + 6,
                        getColor()
                );
            } else {
                ...
                BananaCat.INSTANCE.mc.fontRendererObj.drawString(
                        TimeHelper.getFormattedTimeSecond(),
                        getX() + getW() / 2 - (BananaCat.INSTANCE.mc.fontRendererObj.getStringWidth(TimeHelper.getFormattedTimeSecond())) / 2,
                        getY() + 6, getColor()
                );
            }
