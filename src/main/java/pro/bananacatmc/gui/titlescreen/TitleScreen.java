...
package pro.bananacatmc.gui.titlescreen;

import pro.bananacatmc.BananaCat;
import pro.bananacatmc.gui.titlescreen.buttons.IconButton;
import pro.bananacatmc.gui.titlescreen.buttons.TextButton;
import pro.bananacatmc.helpers.font.GlyphPageFontRenderer;
...
public class TitleScreen extends Panorama {
    ...
    /**
     * Draws the main "BananaCat" Text and the Logo in the middle
     */

    private void drawLogo() {
        GlyphPageFontRenderer fontRenderer = BananaCat.INSTANCE.fontHelper.size40;
        fontRenderer.drawString(BananaCat.modName, width / 2f - fontRenderer.getStringWidth(BananaCat.modName) / 2f, height / 2f - 27.5f, -1);
        Helper2D.drawPicture(width / 2 - 30, height / 2 - 78, 60, 60, 0x40ffffff, "BananaCatlogo.png");
    }

    /**
     * Draws the "BananaCat Client" Text and Mojang Copyright Notice on the bottom
     */

    private void drawCopyright() {
        GlyphPageFontRenderer fontRenderer = BananaCat.INSTANCE.fontHelper.size20;
        String copyright = "Copyright Mojang Studios. Do not distribute!";
        String text = BananaCat.modName + " Client " + BananaCat.modVersion;
