...
public class ColorPicker extends Settings {
    ...
    public void renderSetting(int mouseX, int mouseY) {
        ...
        boolean rounded = BananaCat.INSTANCE.optionManager.getOptionByName("Rounded Corners").isCheckToggled();
        int color = BananaCat.INSTANCE.optionManager.getOptionByName("Color").getColor().getRGB();

        BananaCat.INSTANCE.fontHelper.size30.drawString(setting.getName(), button.getPanel().getX() + 20, getYH + 6, color);
        animate.update();
        ...
        BananaCat.INSTANCE.fontHelper.size20.drawString(rgbText, getXW - 45 - BananaCat.INSTANCE.fontHelper.size20.getStringWidth(rgbText), getYH + 9, -1);
