...
package pro.bananacatmc.gui.modmenu.impl.sidebar.mods;
...
import pro.bananacatmc.gui.modmenu.impl.sidebar.mods.impl.type.*;
...
public class Button {
    ...
    public Button(Mod mod, Panel panel, int x, int y) {
        ...
        if (BananaCat.INSTANCE.settingManager.getSettingsByMod(mod) != null) {
            int addY = 70;
            for (Setting setting : BananaCat.INSTANCE.settingManager.getSettingsByMod(mod)) {
    ...
    public void renderButton(int mouseX, int mouseY) {
        ...
        if (!getPanel().isAnyButtonOpen()) {
            ...
            BananaCat.INSTANCE.fontHelper.size20.drawString(mod.getName(), panel.getX() + 10 + x, panel.getY() + panel.getH() + y + 97, color);
        ...
        if (open) {
            ...
            BananaCat.INSTANCE.fontHelper.size30.drawString(mod.getName(), panel.getX() + 5 + 7, panel.getY() + panel.getH() + 5 + 8 + 300 - animPanel.getValueI(), color);
            BananaCat.INSTANCE.fontHelper.size20.drawString(mod.getDescription(), panel.getX() + 20 + BananaCat.INSTANCE.fontHelper.size30.getStringWidth(mod.getName()), panel.getY() + panel.getH() + 316 - animPanel.getValueI(), color);
