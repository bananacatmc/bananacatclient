...
import pro.bananacatmc.feature.mod.impl.crosshair.CrosshairMod;
import pro.bananacatmc.feature.mod.impl.crosshair.LayoutManager;
...
public class CellGrid extends Settings {
    ...
    public void renderSetting(int mouseX, int mouseY) {
        ...
        int width = BananaCat.INSTANCE.fontHelper.size20.getStringWidth(text);
        int x = button.getPanel().getX() + button.getPanel().getW() - 20 - width;
        int y = button.getPanel().getY() + button.getPanel().getH() + getY() + 135;

        BananaCat.INSTANCE.fontHelper.size20.drawString(text, x - 3, y + 6, -1);
