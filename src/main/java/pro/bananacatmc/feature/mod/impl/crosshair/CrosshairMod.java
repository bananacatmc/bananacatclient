...
package pro.bananacatmc.feature.mod.impl.crosshair;
...
public class CrosshairMod extends Mod {
    ...
    public CrosshairMod() {
        ...
        BananaCat.INSTANCE.settingManager.addSetting(new Setting("Color", this, new Color(255, 255, 255), new Color(255, 0, 0), 0, new float[]{0, 0}));
        BananaCat.INSTANCE.settingManager.addSetting(new Setting("Cells", this, layoutManager.getLayout(0)));
    }
    ...
    private int color() {
        return BananaCat.INSTANCE.settingManager.getSettingByModAndName(getName(), "Color").getColor().getRGB();
    }

    private boolean[][] getCells() {
        return BananaCat.INSTANCE.settingManager.getSettingByModAndName(getName(), "Cells").getCells();
    }
}
