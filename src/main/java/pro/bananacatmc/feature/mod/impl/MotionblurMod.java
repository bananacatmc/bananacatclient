...
public class MotionblurMod extends Mod {
    ...
    public MotionblurMod() {
        ...
        BananaCat.INSTANCE.settingManager.addSetting(new Setting("Amount", this, 10, 6));
    }
    ...
    public void renderOverlay(RenderGameOverlayEvent.Post event) {
        if (BananaCat.INSTANCE.mc.currentScreen == null) {
            if (event.type == RenderGameOverlayEvent.ElementType.ALL) {
                if (OpenGlHelper.isFramebufferEnabled()) {
                    int width = BananaCat.INSTANCE.mc.getFramebuffer().framebufferWidth;
                    int height = BananaCat.INSTANCE.mc.getFramebuffer().framebufferHeight;
                    ...
                    BananaCat.INSTANCE.mc.getFramebuffer().bindFramebufferTexture();
                    ...
                    BananaCat.INSTANCE.mc.getFramebuffer().bindFramebuffer(true);
    ...
    private float getAmount() {
        return BananaCat.INSTANCE.settingManager.getSettingByModAndName(getName(), "Amount").getCurrentNumber();
    }
}
