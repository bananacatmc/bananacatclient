...
package pro.bananacatmc.helpers.render;
...
public class Helper3D {
    ...
    public static double calculateCameraDistance(double d0, double d1, double d2, double d3) {
        ...
        if (BananaCat.INSTANCE.mc.gameSettings.thirdPersonView == 2) {
            f2 += 180.0F;
        }
        ...
        for (int i = 0; i < 8; ++i) {
            ...
            f4 = f4 * 0.1F;
            f5 = f5 * 0.1F;
            MovingObjectPosition movingobjectposition = BananaCat.INSTANCE.mc.theWorld.rayTraceBlocks(
